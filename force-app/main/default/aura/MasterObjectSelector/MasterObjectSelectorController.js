        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {   
                ...
                for(var i=0;i<allValues.length;i++){
                    console.log(allValues[i].objectLabel + ' ***ObjectLabel****' + allValues[i].objectName);
                	options.push({
    ...
    selectFormat : function (component, event, helper) {
        ...
        if(selectedValue2 == undefined || selectedValue2 == ''){
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {   
                    JunodocUrl = response.getReturnValue();
                  // window.open('/'+JunodocUrl+'/JunoDoc__PDFTemplateBuilder?objectName='+ selectedValue2, '_self'); 
                  window.open('/'+JunodocUrl+'/JunoDoc__WordDocTemplateBuilder?objectName='+ selectedValue2+'&TemplateType=PDF New', '_self');
                }                    
            });
            $A.enqueueAction(action); 
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {   
                    JunodocUrl = response.getReturnValue();
		            window.open('/'+JunodocUrl+'/JunoDoc__EmailTemplateBuilder?objectName='+ selectedValue2, '_self');
                }                    
            });
            $A.enqueueAction(action);             
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {   
                    JunodocUrl = response.getReturnValue();
		            window.open('/'+JunodocUrl+'/JunoDoc__WordDocTemplateBuilder?objectName='+ selectedValue2+'&TemplateType=Word Document', '_self');
                }                    
            });
            $A.enqueueAction(action);             
        ...
        //New code
            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {   
                    JunodocUrl = response.getReturnValue();
		            window.open('/'+JunodocUrl+'/JunoDoc__ExcelTemplateBuilder?objectName='+ selectedValue2+'&TemplateType=Excel', '_self');
                }                    
            });
            $A.enqueueAction(action);             
